...
export const updateComicMetadata = (comicId: number, updates: { series?: string; upc?: string | null; cover_artist?: string | null; cover_letter?: string | null; volume?: string | null; publisher?: string | null; img?: string | null }) =>
